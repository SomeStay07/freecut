/**
 * Cross-feature contract for the preview feature's transform-gizmo primitives.
 *
 ...
 * timeline keyframes, selection/preview-bridge) come along. All
 * `@/features/preview/*` imports live here (per the deps contract boundary
 * rule); the sibling `gizmo.ts` re-exports from this file.
 */
