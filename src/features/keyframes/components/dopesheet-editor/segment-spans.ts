/**
 * Pure geometry helper for the dopesheet keyframe grid: turns plotted points
 * into clickable spans between consecutive keyframes. Split out of
 * `dopesheet-timeline-cells.tsx` so that file stays component-only (React Fast
 * Refresh only works when a module exports components alone).
 */
