...
import { computeCoverDrawRect, computeFilmstripCanvasGeometry } from './filmstrip-canvas-geometry'
...
export const VisibleFilmstripCanvas = memo(function VisibleFilmstripCanvas({
  ...
  }, [coverFrame, height, imageRevision, renderWidth, tiles, visibleEndPx, visibleStartPx])
