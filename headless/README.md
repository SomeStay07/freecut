...
When you're hand-authoring a `project.json` and just need to check *where things
landed*, don't render a clip and extract a frame with ffmpeg — that's the slow
...
returns near-instantly. Use it to trust coordinates *without* rendering.
